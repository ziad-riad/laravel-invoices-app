<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/logo.png')}}" width="100" height="200" class="main-logo" alt="logo"></a>
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category"><h2>برنامج الفواتير</h2></li>
					<li class="slide">
				...
				@can('الفواتير')
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><i class="fas fa-file-invoice fa-lg"></i> &nbsp;&nbsp;&nbsp;   <span class="side-menu__label">الفواتير</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							@can('قائمة الفواتير')
							...
							<li><a class="slide-item" href="{{ url('/' . $page='invoice_paid') }}">الفواتيرالمدفوعه</a></li>
							@endcan
				...
				@can('المستخدمين')
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><i class="fas fa-users fa-lg"></i>&nbsp;&nbsp;&nbsp;<span class="side-menu__label">المستخدمين</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
				...
				@can('الاعدادات')
					<li class="side-item side-item-category"><span>الاعدادات</span></li>
					
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><i class="fas fa-user-cog fa-lg"></i>&nbsp;&nbsp;&nbsp;<span class="side-menu__label">الاعدادات</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							@can('الاقسام')
