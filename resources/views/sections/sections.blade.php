						...
						<div class="card">
							<div class="card-header pb-0">
								...
								<div class="col-sm-6 col-md-4 col-xl-3 mg-t-20">
									<a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-rotate-left" data-toggle="modal" href="#modaldemo8">اضافة قسم</a>
								</div>
								@endcan
							<div class="card-body">
											...
											<tr>
												...
												<td>
													...
													@can('حذف قسم')
														...
														data-id="{{ $item->id }}" data-section="{{ $item->section }}" data-toggle="modal"
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content modal-content-demo">
					...
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control" id="section" name="section" aria-label="Dollar amount (with dot and two decimal places)">
					</div>

					<div class="form-floating">
						<label for="floatingTextarea2">الملاحظات</label>
					...
					<div class="modal-footer">
						...
						<button class="btn ripple btn-secondary" data-dismiss="modal" type="button">اٍغلاق</button>
					</div>
				    	</form>
				</div>
			</div>
