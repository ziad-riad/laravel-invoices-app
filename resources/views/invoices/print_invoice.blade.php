								...
								<div class="card-body">
									...
									<div class="row mg-t-20">
										...
										<div class="col-md">
											...
											<p class="invoice-info-row"><span> تاريخ الاٍصدار</span> <span>{{$invoices->invoice_date}}</span></p>
											<p class="invoice-info-row"><span>تاريخ الاستحقاق</span> <span>{{$invoices->due_date}}</span></p>
											<p class="invoice-info-row"><span>القسم</span> <span>{{$invoices->sections->section}}</span></p>
										</div>
									</div>
										...
										<table class="table table-invoice border text-md-nowrap mb-0">
											...
											<tbody>
												...
												<tr>
													...
													<td class="tx-right" colspan="2">{{$invoices->total}}$</td>
												</tr>
												<tr>
													<td class="tx-right">قيمة الضريبه ({{$invoices->rate_tax}})</td>
                                                    @php
                                                    
                                                    @endphp
													<td class="tx-right" colspan="2"> {{$invoices->rate_tax}}</td>
												</tr>
												<tr>
												...
												<tr>
                                                    ...
                                                    @php
                                                        $totaly = $invoices->Amount_collection + $invoices->Amount_commission
                                                    @endphp
													<td class="tx-right" colspan="2">
														<h4 class="tx-primary tx-bold">${{$totaly}}</h4>
													</td>
												</tr>
											</tbody>
										</table>
