...
@section('content')
				...
				<script>
					window.onload = function() {
						notif({
							msg: "تم اٍسترجاع أرشفة الفاتورة بنجاح",
							type: "success"
						})
					}
				</script>
							...
							<div class="card">
								<div class="card-header pb-0">
										...
										<div class="col-sm-6 col-md-4 col-xl-3 mg-t-20">
											@can('اضافة فاتوره')
											<a href="invoices/create" class="modal-effect btn btn-sm btn-primary" style="color:white ; font-weight: bolder "><i
												class="fas fa-plus"></i>&nbsp; اضافة فاتورة</a>
											@endcan
											@can('تصدير EXCEL')
											<a href="/invoice_export" class="modal-effect btn btn-sm btn-primary" style="color:white ;font-weight: bolder"><i
												class="fas fa-plus" ></i>&nbsp; تصد ير اٍكسل </a>
											@endcan
										</div>
								</div>
								<div class="card-body">
													...
													<td>
														<div class="dropdown">
															...
															<div class="dropdown-menu tx-13">
																@can('تعديل الفاتوره')
																<a class="dropdown-item" href="{{url('edit_invoice')}}/{{$item->id}}"><i class="far fa-edit" style="color: seagreen"></i>&nbsp;&nbsp;تعديل الفاتوره</a>
																@endcan
																@can('حذف الفاتوره')
																...
																@endcan
																@can('تغير حالة الدفع')
																	<a class="dropdown-item" href="{{URL::route('status_show',[$item->id])}}"><i class="fas fa-plus-circle" style="color: springgreen"></i>&nbsp;&nbsp;تغيير حالة الدفع  </a>
																@endcan
																@can('ارشفة الفاتوره')
																	<a class="dropdown-item" href="#" data-invoice_id="{{$item->id}}" 
																		data-toggle="modal" data-target="#transfer_invoice"><i
																		class="fas fa-archive" style="color: rgb(241, 160, 174)"></i>&nbsp;&nbsp; أرشفة الفاتوره</a>
																@endcan
																@can('طباعة الفاتوره')
																		<a class="dropdown-item" href="{{url('print_invoice')}}/{{$item->id}}"><i class="fas fa-print" style="color: black"></i>&nbsp;&nbsp;طباعة الفاتورة</a>
																@endcan
