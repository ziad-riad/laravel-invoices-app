                    ...
                    <form action="{{route('status_update',['id'=>$invoices->id]) }}" method="post" 
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_date" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ date('Y-m-d') }}" value="{{$invoices->invoice_}}" readonly>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select name="section" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                        ...
                                        <option value="{{ $invoices->sections->id }}"> {{ $invoices->sections->section }}</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="rate_tax" id="rate_tax" class="form-control" onchange="myFunction()" readonly>
                                    <!--placeholder-->
                                    <option value="" selected disabled >{{$invoices->rate_tax}}</option>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="value_tax" name="value_tax" value="{{$invoices->value_tax}}" readonly>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="example-textarea" class="control-label">   حالة الدفع</label>
                                <select class="form-control" name="status" id="status">
                                    <option selected='true' disabled='disabled'> حالة الدفع</option>

                                    <option value="مدفوعه"><span>مدفوعه</span>  </option>
                                    <option value="مدفوعه جزئيا"> <span>مدفوعه جزئياََ</span>   </option>
                                </select>
                            </div>

                            <div class="col">
                                <label for="inputName" class="control-label">تاريخ الدفع  </label>
                                <input type="text" class="form-control fc-datepicker" placeholder="YYYY-MM-DD" id="payment_date" name="payment_date"  required>
                            </div>
                        </div>
