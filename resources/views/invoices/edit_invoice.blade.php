                    ...
                    <form action="{{ url('invoices/update') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="rate_tax" id="rate_tax" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                                    <option >{{$invoices->rate_tax}}</option>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="value_tax" name="value_tax" readonly value="{{$invoices->value_tax}}">
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="note" rows="3" value="{{$invoices->note}}">{{$invoices->note}}</textarea>
                            </div>
                        </div><br>
